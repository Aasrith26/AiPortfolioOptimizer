...
def get_portfolio():
    ...
    # 1) KPI pipeline (fire-and-forget)
    job_id = None
    try:
    ...
    expected_returns = forecaster.generate_forecasted_returns(local_returns, {a: heuristic_sentiments[a] for a in investable})

    # 4) Optimize (slider or profile)
...
if __name__ == "__main__":
    # No direct initialize_data() call here — it's handled by before_first_request
